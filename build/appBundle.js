...
var APP_com_epam_app_lightingSchool = (function () {
  ...
  const bootRouter = (config, instance) => {
    ...
    application$1 = app.application;
    pagesHost = application$1.childList;
    stage$1 = app.stage;
  ...
  const navigate$1 = (url, args = {}, store) => {
    if (isObject(url)) {
  ...
  class BaseScreen extends Lightning.Component {
    show() {
      this.visible = true;
    }
  ...
  class SportsScreen extends BaseScreen {
    static _template() {
      return {
        Text: {
          text: {
  ...
  class NavigationItem extends Lightning.Component {
    _handleEnter() {
  ...
  class HeaderItem extends NavigationItem {
    static _template() {
      return {
        flexItem: {
          marginLeft: 100,
    ...
    set item(value) {
      this.tag('Text').patch({
        ...
        fontFace: 'sans-serif',
        textColor: 0xffffffff,
        textAlign: 'center' // route: this.tag('Text').toLowerCase(),
    ...
    _focus() {
      ...
      this.tag('Text').color = 0xff1f1f1f; // this.setSmooth('alpha', 1)
      // this.tag('Text').setSmooth('color', '0xffff00ff')
    }

    _unfocus() {
      this.color = 0xffffffff;
      this.tag('Text').color = 0xffffffff; // this.setSmooth('alpha', 0.5)
  ...
  class Header extends Lightning.Component {
    ...
    _init() {
      ...
      this.tag('CentralBlock').children = itemData.map(item => {
        return {
          type: HeaderItem,
          text: item.toUpperCase() // route: item.toLowerCase(),
    ...
    static _states() {
      return [class Focus extends this {
        _getFocused() {
  ...
  class Slider extends Lightning.Component {
    static getFonts() {
      return [{
        family: 'DejaVu Sans',
        url: Utils.asset('fonts/DejaVuSans.ttf')
      }];
    }
    ...
    _focus() {
      this.color = 0xffff0000;
      this.tag('ImageDeadpool').color = 0xffff00ff; // this.setSmooth('alpha', 1)
      // this.tag('Text').setSmooth('color', '0xffff00ff')
    }

    _unfocus() {
      this.color = 0xffffffff;
      this.tag('ImageDeadpool').color = 0xffffffff; // this.setSmooth('alpha', 0.5)
      // this.tag('Text').setSmooth('color', '0xffffffff')
    }
  ...
  class App extends Lightning.Component {
    ...
    static _template() {
      return {
        Background: {
          ...
          h: 1080,
          //color black
          color: 0xff000000 // src: Utils.asset('../static/images/background.png'),
    ...
    _init() {
      ...
      //   })
      //   .start()
      navigate('home'); // this._setState('HeaderState')
    }

    static _states() {
      return [class Header extends this {
        _getFocused() {
